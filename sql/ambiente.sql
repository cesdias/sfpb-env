...
INSERT INTO app.label VALUES
 ...
 Emissão de NF-e pelo contribuinte com aplicativo fornecido pelo Fisco.', 'Grupo B. Identificação da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (27, 'infnfe_emit_enderemi_xbairro', 'character varying', 'Bairro', 'sim', NULL, 'Grupo C. Identificação do Emitente da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (34, 'infnfe_emit_enderemit_fone', 'character varying', 'Código DDD + número do telefone (v.2.0)', 'sim', NULL, 'Grupo C. Identificação do Emitente da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (48, 'infnfe_dest_enderdest_cmun', 'character varying', 'Código do município', 'sim', 'Utilizar a tabela do IBGE, informar 9999999 para operações com o exterior', 'Grupo E. Identificação do Destinatário da Nota Fiscal eletrônica', 'fatonfe'),
  (49, 'infnfe_dest_enderdest_xmun', 'character varying', 'Nome do município', 'sim', 'Informar EXTERIOR para operações com o exterior', 'Grupo E. Identificação do Destinatário da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (51, 'infnfe_dest_enderdest_cep', 'character varying', 'CEP', 'sim', 'Informar EX para operações com o exterior', 'Grupo E. Identificação do Destinatário da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (54, 'infnfe_dest_enderdest_fone', 'character varying', 'Código DDD + número do telefone (v.2.0)', 'sim', NULL, 'Grupo E. Identificação do Destinatário da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (56, 'infnfe_dest_ie', 'character varying', 'Inscrição Estadual', 'sim', 'Obrigatório nas operações com contribuintes do ICMS', 'Grupo E. Identificação do Destinatário da Nota Fiscal eletrônica', 'fatonfe'),
  ...
  (78, 'infnfe_det_imposto_icms_icms00_cst', 'integer', 'Tributação pelo ICMS00 - Tributada integralmente', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
...
CREATE MATERIALIZED VIEW appmask.fatoitemnfe AS SELECT
    ...
    infNFe_det_imposto_ICMS_ICMS00_orig,
    infNFe_det_imposto_ICMS_ICMS00_CST,
    infNFe_det_imposto_ICMS_ICMS00_modBC,
    infNFe_det_imposto_ICMS_ICMS00_vBC,
    infNFe_det_imposto_ICMS_ICMS00_pICMS,
    infNFe_det_imposto_ICMS_ICMS00_vICMS
