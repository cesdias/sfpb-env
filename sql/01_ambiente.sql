...
CREATE TABLE app.fatomdfe (
	...
	infmdfe_versao varchar NULL,
	infmdfe_id varchar(48) NULL,
	infmdfe_ide_cuf varchar(2) NULL,
	infmdfe_ide_tpamb bpchar(1) NULL,
	infmdfe_ide_tpemit bpchar(1) NULL,
	infmdfe_ide_tptransp bpchar(1) NULL,
	infmdfe_ide_mod varchar(2) NULL,
	infmdfe_ide_serie varchar(3) NULL,
	infmdfe_ide_nmdf varchar(9) NULL,
	infmdfe_ide_cmdf varchar(8) NULL,
	infmdfe_ide_cdv bpchar(1) NULL,
	infmdfe_ide_modal bpchar(1) NULL,
	infmdfe_ide_dhemi timestamptz NULL,
	infmdfe_ide_tpemis bpchar(1) NULL,
	infmdfe_ide_procemi bpchar(1) NULL,
	infmdfe_ide_verproc varchar(20) NULL,
	infmdfe_ide_ufini varchar(2) NULL,
	infmdfe_ide_uffim varchar(2) NULL,
	infmdfe_ide_infmuncarrega_cmuncarrega varchar(7) NULL,
	infmdfe_ide_infmuncarrega_xmuncarrega varchar(60) NULL,
	infmdfe_ide_infpercurso_ufper varchar(2) NULL,
	infmdfe_ide_dhiniviagem timestamptz NULL,
	infmdfe_ide_indcanalverde bpchar(1) NULL,
	infmdfe_ide_indcarregaposterior bpchar(1) NULL,
	infmdfe_emit_cnpj varchar(14) NULL,
	infmdfe_emit_cpf varchar(11) NULL,
	infmdfe_emit_ie varchar(14) NULL,
	infmdfe_emit_xnome varchar(60) NULL,
	infmdfe_emit_xfant varchar(60) NULL,
	infmdfe_emit_enderemit_xlgr varchar(60) NULL,
	infmdfe_emit_enderemit_nro varchar(60) NULL,
	infmdfe_emit_enderemit_xcpl varchar(60) NULL,
	infmdfe_emit_enderemit_xbairro varchar(60) NULL,
	infmdfe_emit_enderemit_cmun varchar(7) NULL,
	infmdfe_emit_enderemit_xmun varchar(60) NULL,
	infmdfe_emit_enderemit_cep varchar(8) NULL,
	infmdfe_emit_enderemit_uf varchar(2) NULL,
	infmdfe_emit_enderemit_fone varchar(12) NULL,
	infmdfe_emit_enderemit_email varchar(60) NULL,
	infmdfe_infmodal_versaomodal varchar NULL,
	infmdfe_infmodal_rodo_infantt_rntrc varchar(8) NULL,
	infmdfe_infmodal_rodo_veictracao_cint varchar(10) NULL,
	infmdfe_infmodal_rodo_veictracao_placa varchar(7) NULL,
	infmdfe_infmodal_rodo_veictracao_renavam varchar(11) NULL,
	infmdfe_infmodal_rodo_veictracao_tara varchar(6) NULL,
	infmdfe_infmodal_rodo_veictracao_capkg varchar(6) NULL,
	infmdfe_infmodal_rodo_veictracao_capm3 varchar(3) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_cpf varchar(11) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_cnpj varchar(14) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_rntrc varchar(8) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_xnome varchar(60) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_ie varchar(14) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_uf varchar(2) NULL,
	infmdfe_infmodal_rodo_veictracao_prop_tpprop bpchar(1) NULL,
	infmdfe_infmodal_rodo_veictracao_condutor_xnome varchar(60) NULL,
	infmdfe_infmodal_rodo_veictracao_condutor_cpf varchar(11) NULL,
	infmdfe_infmodal_rodo_veictracao_tprod bpchar(2) NULL,
	infmdfe_infmodal_rodo_veictracao_tpcar bpchar(2) NULL,
	infmdfe_infmodal_rodo_veictracao_uf bpchar(2) NULL,
	infmdfe_infmodal_rodo_veicreboque_cint varchar(10) NULL,
	infmdfe_infmodal_rodo_veicreboque_placa varchar NULL,
	infmdfe_infmodal_rodo_veicreboque_renavam varchar(11) NULL,
	infmdfe_infmodal_rodo_veicreboque_tara varchar(6) NULL,
	infmdfe_infmodal_rodo_veicreboque_capkg varchar(6) NULL,
	infmdfe_infmodal_rodo_veicreboque_capm3 varchar(3) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_cpf varchar(11) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_cnpj varchar(14) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_rntrc varchar(8) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_xnome varchar(60) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_ie varchar(14) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_uf bpchar(2) NULL,
	infmdfe_infmodal_rodo_veicreboque_prop_tpprop bpchar(1) NULL,
	infmdfe_infmodal_rodo_veicreboque_tpcar bpchar(2) NULL,
	infmdfe_infmodal_rodo_veicreboque_uf bpchar(2) NULL,
	infmdfe_infmodal_rodo_veicreboque_codagporto varchar(16) NULL,
	infmdfe_infmodal_aereo_nac varchar NULL,
	infmdfe_infmodal_aereo_matr varchar(6) NULL,
	infmdfe_infmodal_aereo_nvoo varchar(9) NULL,
	infmdfe_infmodal_aereo_caeremb varchar NULL,
	infmdfe_infmodal_aereo_caerdes varchar NULL,
	infmdfe_infmodal_aereo_dvoo date NULL,
	infmdfe_infmodal_ferrov_trem_xpref varchar(10) NULL,
	infmdfe_infmodal_ferrov_trem_dhtrem timestamp NULL,
	infmdfe_infmodal_ferrov_trem_xori varchar(3) NULL,
	infmdfe_infmodal_ferrov_trem_xdest varchar(3) NULL,
	infmdfe_infmodal_ferrov_trem_qvag varchar(3) NULL,
	infmdfe_infmodal_aquav_irin varchar(10) NULL,
	infmdfe_infmodal_aquav_tpemb bpchar(2) NULL,
	infmdfe_infmodal_aquav_cembar varchar(10) NULL,
	infmdfe_infmodal_aquav_xembar varchar(60) NULL,
	infmdfe_infmodal_aquav_nviag varchar(10) NULL,
	infmdfe_infmodal_aquav_cprtemb varchar(5) NULL,
	infmdfe_infmodal_aquav_cprtdest varchar(5) NULL,
	infmdfe_infmodal_aquav_prttrans varchar(60) NULL,
	infmdfe_infmodal_aquav_tpnav bpchar(1) NULL,
	infmdfe_infmodal_aquav_inftermcarreg_ctermcarreg varchar(8) NULL,
	infmdfe_infmodal_aquav_inftermcarreg_xtermcarreg varchar(60) NULL,
	infmdfe_infmodal_aquav_inftermdescarreg_ctermcarreg varchar(8) NULL,
	infmdfe_infmodal_aquav_inftermdescarreg_xtermcarreg varchar(60) NULL,
	infmdfe_infmodal_aquav_infembcomb_cembcomb varchar(10) NULL,
	infmdfe_infmodal_aquav_infembcomb_xbalsa varchar(60) NULL,
	infmdfe_tot_qcte varchar(6) NULL,
	infmdfe_tot_qnfe varchar(6) NULL,
	infmdfe_tot_qmdfe varchar(6) NULL,
	infmdfe_tot_vcarga numeric(16, 4) NULL,
	infmdfe_tot_cunid varchar(2) NULL,
	infmdfe_tot_qcarga numeric(16, 4) NULL,
	infmdfe_autxml_cnpj varchar(14) NULL,
	infmdfe_autxml_cpf varchar(11) NULL,
	infmdfe_infadic_infadfisco varchar(2000) NULL,
	infmdfe_infadic_infcpl varchar(5000) NULL,
	infmdfe_infresptec_cnpj varchar(14) NULL,
	infmdfe_infresptec_xcontato varchar(60) NULL,
	infmdfe_infresptec_email varchar(60) NULL,
	infmdfe_infresptec_fone varchar(12) NULL,
	infmdfe_infresptec_idcsrt varchar(3) NULL,
	infmdfe_infresptec_hashcsrt varchar(28) NULL,
	informix_stmdfeletronica bpchar(1) NOT NULL DEFAULT 'A'::bpchar,
	CONSTRAINT fatomdfe_pkey PRIMARY KEY (protmdfe_infprot_chmdfe)
);
