...
INSERT INTO app.label VALUES (22, 'infnfe_ide_procemi', 'integer', 'Processo de emissão utilizado com a seguinte codificação', 'não', '0 - Emissão de NF-e com aplicativo do contribuinte; 1 - Emissão de NF-e avulsa pelo Fisco; 2 - Emissão de NF-e avulsa, pelo contribuinte com seu certificado digital, através do sitedo Fisco; 3 - 
...
CREATE TABLE app.fatoeventocte(
	...
	eventoCTe_infEvento_detEvento_evCTeAnulado_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeAutorizadoMDFe_MDFe_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeCanceladoMDFe_MDFe_nProtCanc char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeComplementar_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeMultimodal_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeRedespacho_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeRedespachoInter_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeSubcontratacao_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCTeSubstituido_nProt char(1),
	...
	eventoCTe_infEvento_detEvento_evCancCTeComplementar_nProt char(1),
