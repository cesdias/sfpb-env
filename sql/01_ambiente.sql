...
REATE TABLE app.fatonfe(
	...
	infNFe_total_ICMSTot_vNF numeric(16,2),
   	...
   	infNFe_cobr_dup_nDup character varying(60),
   	infNFe_cobr_dup_dVenc timestamp with time zone,
   	infNFe_cobr_dup_vDup numeric(16,2),
