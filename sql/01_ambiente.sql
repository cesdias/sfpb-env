...
INSERT INTO app.label VALUES
    ...
    (88, 'infnfe_pag_detpag_indpag', 'character varying', 'Indicador da Forma de Pagamento', 'não', '0 - Pagamento à Vista; 1 - Pagamento à Prazo', 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (89, 'infnfe_pag_detpag_tpag', 'character varying', 'Forma de Pagamento', 'não', '01 - Dinheiro; 02 - Cheque; 03 - Cartão de Crédito; 04 - Cartão de Débito; 05 - Crédito Loja; 10 - Vale Alimentação; 11 - Vale Refeição; 12 - Vale Presente; 13 - Vale Combustível; 14 - Duplicata Mercantil; 15 - Boleto Bancario; 90 - Sem Pagamento; 99 - Outros', 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (90, 'infnfe_pag_detpag_vpag', 'numeric', 'Valor do Pagamento', 'não', 'Esta tag poderá ser omitida quando a tag tPag=90 (Sem Pagamento), caso contrário deverá ser preenchida', 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (91, 'infnfe_pag_detpag_card_tpintegra', 'character varying', 'Tipo de Integração do processo de pagamento com o sistema de automação da empresa', 'não', '1 = Pagamento integrado com o sistema de automação da empresa. Ex. equipamento TEF, Comercio Eletronico; 2 = Pagamento não integrado com o sistema de automação da empresa. Ex: equipamento POS', 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (92, 'infnfe_pag_detpag_card_cnpj', 'character varying', 'CNPJ da credenciadora de cartão de crédito/débito', 'não', NULL, 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (93, 'infnfe_pag_detpag_card_tband', 'character varying', 'Bandeira da operadora de cartão de crédito/débito', 'não', '01 - Visa; 02 - Mastercard; 03 - American Express; 04 - Sorocred; 05 - Diners Club; 06 - Elo; 07 - Hipercard; 08 - Aura; 09 - Cabal; 99 - Outros', 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (94, 'infnfe_pag_detpag_card_caut', 'character varying', 'Número de autorização da operação cartão de crédito/débito', 'não', NULL, 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (95, 'infnfe_pag_vtroco', 'numeric', 'Valor do Troco', 'não', NULL, 'Grupo YA. Formas de Pagamento', 'fatonfe'),
    (96, 'infnfe_infadic_infadfisco', 'character varying', 'Informações adicionais de interesse do Fisco (v2.0)', 'não', 'Observação UFPB: pega apenas 1.a ocorrencia', 'Grupo Z. Informações Adicionais da NF-e', 'fatonfe'),
    (97, 'infnfe_infadic_infcpl', 'character varying', 'Informações complementares de interesse do Contribuinte', 'não', NULL, 'Grupo Z. Informações Adicionais da NF-e', 'fatonfe'),
    (98, 'infnfe_infadic_obscont_xcampo', 'character varying', 'Grupo campo de uso livre do contribuinte', 'não', 'Informar o nome do campo no atributo xCampo e o conteúdo do campo no xTexto', 'Grupo Z. Informações Adicionais da NF-e', 'fatonfe'),
    (99, 'infnfe_infadic_obscont_xtexto', 'character varying', 'Conteúdo do campo - Informações adicionais da NF-e', 'não', NULL, 'Grupo Z. Informações Adicionais da NF-e', 'fatonfe'),
    (100, 'informix_stnfeletronica', 'character', 'Situação da Nota Fiscal Eletrônica', 'não', 'A - Autorizada dentro do prazo; C - Cancelada; D - Denegada por irregularidade do Emitente; O - Autorizada fora do prazo; I - Denegada por irregularidade do Destinatário; U- Denegação por Destinatário não habilitado a operar na UF', 'Informações do Informix', 'fatonfe'),
    (101, 'informix_dhconexao', 'character varying', 'Data e hora da conexão de envio da Nota Fiscal Eletrônica', 'não', NULL, 'Informações do Informix', 'fatonfe'),
    (102, 'informix_nriptransmissor', 'character varying', 'IP da conexão de envio da Nota Fiscal Eletrônica', 'sim', NULL, 'Informações do Informix', 'fatonfe'),
    (103, 'informix_nrportacon', 'integer', 'Porta da conexão de envio da Nota Fiscal Eletrônica', 'não', NULL, 'Informações do Informix', 'fatonfe'),
    (104, 'id', 'bigint', 'Índice de fatoitemnfe', 'não', NULL, NULL, 'fatoitemnfe'),
    (105, 'infprot_chnfe', 'character varying', 'Chaves de acesso da NF-e', 'sim', 'compostas por: UF do emitente, AAMM da emissão da NFe, CNPJ do emitente, modelo, série e número da NF-e e código numérico+DV', NULL, 'fatoitemnfe'),
    (106, 'infnfe_det_nitem', 'character varying', 'Dados dos detalhes da NF-e', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (107, 'infnfe_det_prod_cprod', 'character varying', 'Código do produto ou serviço', 'não', 'Preencher com CFOP caso se trate de itens não relacionados com mercadorias/produto e que o contribuinte não possua codificação própriaFormato ”CFOP9999”', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (108, 'infnfe_det_prod_cean', 'character varying', 'GTIN (Global Trade Item Number) do produto', 'não', 'Antigo código EAN ou código de barras', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (109, 'infnfe_det_prod_xprod', 'character varying', 'Descrição do produto ou serviço', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (110, 'infnfe_det_prod_ncm', 'character varying', 'Código NCM (8 posições)', 'não', 'Será permitida a informação do gênero (posição do capítulo do NCM) quando a operação não for de comércio exterior (importação/exportação) ou o produto não seja tributado pelo IPI. Em caso de item de serviço ou item que não tenham produto (Ex. transferência de crédito, crédito do ativo imobilizado, etc.), informar o código 00 (zeros) (v2.0)', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (111, 'infnfe_det_prod_cfop', 'character varying', 'Cfop', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (112, 'infnfe_det_prod_ucom', 'character varying', 'Unidade comercial', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (113, 'infnfe_det_prod_qcom', 'numeric', 'Quantidade Comercial  do produto', 'não', 'Alterado para aceitar de 0 a 4 casas decimais e 11 inteiros', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (160, 'infnfe_det_imposto_icms_picmsst', 'numeric', 'Alíquota do ICMS ST', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (114, 'infnfe_det_prod_vuncom', 'numeric', 'Valor unitário de comercialização  ', 'não', 'Alterado para aceitar 0 a 10 casas decimais e 11 inteiros', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (115, 'infnfe_det_prod_vprod', 'numeric', 'Valor bruto do produto ou serviço', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (116, 'infnfe_det_prod_ceantrib', 'character varying', 'GTIN (Global Trade Item Number) da unidade tributável', 'não', 'Antigo código EAN ou código de barras', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (117, 'infnfe_det_prod_utrib', 'character varying', 'Unidade Tributável', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (118, 'infnfe_det_prod_qtrib', 'numeric', 'Quantidade Tributável ', 'não', 'Alterado para aceitar de 0 a 4 casas decimais e 11 inteiros', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (119, 'infnfe_det_prod_vuntrib', 'numeric', 'Valor unitário de tributação ', 'não', 'Alterado para aceitar 0 a 10 casas decimais e 11 inteiros', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (120, 'infnfe_det_prod_vfrete', 'numeric', 'Valor Total do Frete', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (121, 'infnfe_det_prod_vseg', 'numeric', 'Valor Total do Seguro', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (122, 'infnfe_det_prod_vdesc', 'numeric', 'Valor do Desconto', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (123, 'infnfe_det_prod_voutro', 'numeric', 'Outras despesas acessórias', 'não', NULL, 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (124, 'infnfe_det_prod_indtot', 'character varying', 'Indica se o valor da item (vProd) entra no valor total da NFe (vProd)', 'não', '0 – o valor do item (vProd) não compõe o valor total da NF-e (vProd), 1 – o valor do item (vProd) compõe o valor total da NF-e (vProd)', 'Grupo I. Produtos e Serviços da NF-e', 'fatoitemnfe'),
    (125, 'infnfe_det_imposto_vtottrib', 'numeric', 'Valor estimado total de impostos federais, estaduais e municipais', 'não', NULL, 'Grupo M. Tributos incidentes no Produto ou Serviço', 'fatoitemnfe'),
    (126, 'infnfe_det_imposto_icms_orig', 'character varying', 'Origem da mercadoria - ICMS', 'não', '0 - Nacional; 1 - Estrangeira - Importação direta; 2 - Estrangeira - Adquirida no mercado interno', 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (127, 'infnfe_det_imposto_icms_cst', 'character varying', 'Tributação pelo ICMS ', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (128, 'infnfe_det_imposto_icms_csosn', 'character varying', 'Código de situação da operação do simples nacional', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (129, 'infnfe_det_imposto_icms_vbcstret', 'numeric', 'Valor da BC do ICMS retido anteriormente (v2.0) ', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (130, 'infnfe_det_imposto_icms_pst', 'numeric', 'Aliquota suportada pelo consumidor final ', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (131, 'infnfe_det_imposto_icms_vicmssubstituto', 'numeric', 'Valor do ICMS próprio do substituto', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (132, 'infnfe_det_imposto_icms_vicmsstret', 'numeric', 'Valor do ICMS  retido anteriormente (v2.0)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (133, 'infnfe_det_imposto_icms_vbcfcpstret', 'numeric', 'Valor da Base de cálculo do FCP retido anteriormente', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (134, 'infnfe_det_imposto_icms_pfcpstret', 'numeric', 'Percentual de FCP retido anteriormente por substituição tributária', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (135, 'infnfe_det_imposto_icms_vfcpstret', 'numeric', 'Valor do FCP retido por substituição tributária', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (136, 'infnfe_det_imposto_icms_vbcstdest', 'numeric', 'Informar o valor da BC do ICMS da UF destino', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (137, 'infnfe_det_imposto_icms_vicmsstdest', 'numeric', 'Informar o valor da BC do ICMS da UF destino (v2.0)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (138, 'infnfe_det_imposto_icms_predbcefet', 'numeric', 'Percentual de redução da base de cálculo efetiva - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (139, 'infnfe_det_imposto_icms_vbcefet', 'numeric', 'Valor da base de cálculo efetiva - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (140, 'infnfe_det_imposto_icms_picmsefet', 'numeric', 'Alíquota do ICMS efetivo', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (141, 'infnfe_det_imposto_icms_vicmsefet', 'numeric', 'Valor do ICMS efetivo', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (142, 'infnfe_det_imposto_icms_modbc', 'character varying', 'Modalidade de determinação da BC da partilha do ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (143, 'infnfe_det_imposto_icms_predbc', 'numeric', 'Percentual de redução da partilha do BC', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (144, 'infnfe_det_imposto_icms_vbc', 'numeric', 'Valor da BC da partilha do ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (145, 'infnfe_det_imposto_icms_picms', 'numeric', 'Alíquota da partilha do ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (146, 'infnfe_det_imposto_icms_vicmsop', 'numeric', 'Valor do ICMS da Operação', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (147, 'infnfe_det_imposto_icms_pdif', 'numeric', 'Percentual do diferemento - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (148, 'infnfe_det_imposto_icms_vicmsdif', 'numeric', 'Valor do ICMS da diferido', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (149, 'infnfe_det_imposto_icms_vicms', 'numeric', 'Valor do ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (150, 'infnfe_det_imposto_icms_vbcfcp', 'numeric', 'Valor da Base de cálculo do FCP - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (151, 'infnfe_det_imposto_icms_pfcp', 'numeric', 'Percentual de ICMS relativo ao Fundo de Combate à Pobreza (FCP)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (152, 'infnfe_det_imposto_icms_vfcp', 'numeric', 'Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (153, 'infnfe_det_imposto_icms_pfcpdif', 'numeric', 'Percentual do diferimento - ICMS relativo ao Fundo de Combate à Pobreza (FCP)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (154, 'infnfe_det_imposto_icms_vfcpdif', 'numeric', 'Valor diferido do ICMS relativo ao Fundo de Combate à Pobreza (FCP)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (155, 'infnfe_det_imposto_icms_vfcpefet', 'numeric', 'Valor efetivo do ICMS relativo ao Fundo de Combate à Pobreza (FCP)', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (156, 'infnfe_det_imposto_icms_modbcst', 'character varying', 'Modalidade de determinação da BC do ICMS ST', 'não', '0 – Preço tabelado ou máximo sugerido; 1 - Lista Negativa (valor), 2 - Lista Positiva (valor), 3 - Lista Neutra (valor), 4 - Margem Valor Agregado (%), 5 - Pauta (valor), 6 - Valor da Operação', 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (157, 'infnfe_det_imposto_icms_pmvast', 'numeric', 'Percentual da Margem de Valor Adicionado ICMS ST', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (158, 'infnfe_det_imposto_icms_predbcst', 'numeric', 'Percentual de redução da BC ICMS ST', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (159, 'infnfe_det_imposto_icms_vbcst', 'numeric', 'Valor da BC do ICMS ST', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (161, 'infnfe_det_imposto_icms_vicmsst', 'numeric', 'Valor do ICMS ST', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (162, 'infnfe_det_imposto_icms_vbcfcpst', 'numeric', 'Valor da Base de cálculo do FCP retido por substituição tributária - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (163, 'infnfe_det_imposto_icms_pfcpst', 'numeric', 'Percentual de FCP retido por substituição tributária - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (164, 'infnfe_det_imposto_icms_vfcpst', 'numeric', 'Valor do FCP retido por substituição tributária - ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (165, 'infnfe_det_imposto_icms_vicmsdeson', 'numeric', 'Valor do ICMS de desoneração', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (166, 'infnfe_det_imposto_icms_motdesicms', 'character varying', 'Motivo da desoneração do ICMS', 'não', '3 - Uso na agropecuária; 9 - Outros; 12 - Fomento agropecuário', 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (167, 'infnfe_det_imposto_icms_vicmsstdeson', 'numeric', 'Valor do ICMS ST de desoneração', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (168, 'infnfe_det_imposto_icms_motdesicmsst', 'character varying', 'Motivo da desoneração do ICMS ST', 'não', '3 - Uso na agropecuária; 9 - Outros; 12 - Fomento agropecuário', 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (169, 'infnfe_det_imposto_icms_pbcop', 'numeric', 'Percentual para determinação do valor  da Base de Cálculo da operação própria da partilha do ICMS', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (170, 'infnfe_det_imposto_icms_ufst', 'character varying', 'Sigla da UF para qual é devido a partilha do ICMS ST da operação', 'não', NULL, 'Grupo N. ICMS Normal e ST', 'fatoitemnfe'),
    (171, 'infnfe_det_imposto_icms_pcredsn', 'numeric', 'Alíquota aplicável de cálculo do crédito (Simples Nacional) (v2.0) ', 'não', NULL, NULL, 'fatoitemnfe'),
    (172, 'infnfe_det_imposto_ii_vbc', 'numeric', 'Base da BC do Imposto de Importação', 'não', NULL, 'Grupo P. Imposto de Importação', 'fatoitemnfe'),
    (173, 'infnfe_det_imposto_ii_vdespadu', 'numeric', 'Valor das despesas aduaneiras', 'não', NULL, 'Grupo P. Imposto de Importação', 'fatoitemnfe'),
    (174, 'infnfe_det_imposto_ii_vii', 'numeric', 'Valor do Imposto de Importação', 'não', NULL, 'Grupo P. Imposto de Importação', 'fatoitemnfe'),
    (175, 'infnfe_det_imposto_ii_viof', 'numeric', 'Valor do Imposto sobre Operações Financeiras', 'não', NULL, 'Grupo P. Imposto de Importação', 'fatoitemnfe'),
    (176, 'infnfe_det_imposto_icmsufdest_vbcufdest', 'numeric', 'Valor da Base de Cálculo do ICMS na UF do destinatário', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (177, 'infnfe_det_imposto_icmsufdest_vbcfcpufdest', 'numeric', 'Valor da Base de Cálculo do FCP na UF do destinatário - ICMS', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (178, 'infnfe_det_imposto_icmsufdest_pfcpufdest', 'numeric', 'Percentual adicional inserido na alíquota interna da UF de destino - ICMS', 'não', 'Relativo ao Fundo de Combate à Pobreza (FCP) naquela UF', 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (179, 'infnfe_det_imposto_icmsufdest_picmsufdest', 'numeric', 'Alíquota adotada nas operações internas na UF do destinatário para o produto/mercadoria - ICMS', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (180, 'infnfe_det_imposto_icmsufdest_picmsinter', 'character varying', 'Alíquota interestadual das UF envolvidas - ICMS', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (181, 'infnfe_det_imposto_icmsufdest_picmsinterpart', 'numeric', 'Percentual de partilha para a UF do destinatário - ICMS', 'não', '- 4% alíquota interestadual para produtos importados; - 7% para os Estados de origem do Sul e Sudeste (exceto ES), destinado para os Estados do Norte e Nordeste ou ES; - 12% para os demais casos.', 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (182, 'infnfe_det_imposto_icmsufdest_vfcpufdest', 'numeric', 'Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP) da UF de destino', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (183, 'infnfe_det_imposto_icmsufdest_vicmsufdest', 'numeric', 'Valor do ICMS de partilha para a UF do destinatário', 'não', NULL, 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe'),
    (184, 'infnfe_det_imposto_icmsufdest_vicmsufremet', 'numeric', 'Valor do ICMS de partilha para a UF do remetente', 'não', 'Nota: A partir de 2019, este valor será zero.', 'Grupo NA. ICMS para a UF de destino', 'fatoitemnfe')
;
